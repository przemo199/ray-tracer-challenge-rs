...
impl ComputedHit {
    pub fn new(t: f64, object: Box<dyn Shape>, point: Tuple, camera_vector: Tuple, normal_vector: Tuple, reflection_vector: Tuple, is_inside: bool, n1: f64, n2: f64) -> ComputedHit {
...
mod tests {
    ...
    fn schlick_approximation_under_total_internal_reflection() {
        ...
        intersections.add(Intersection::new(2.0_f64.sqrt() / 2.0, shape));
    ...
    fn schlick_approximation_perpendicular_to_viewing_angle() {
        ...
        let mut intersections = Intersections::new();
        intersections.add(Intersection::new(-1.0, shape.clone()));
        intersections.add(Intersection::new(1.0, shape));
        let computed_hit = intersections[1].prepare_computations(&ray, &intersections);
    ...
    fn schlick_approximation_with_small_angle() {
        ...
        let mut intersections = Intersections::new();
        intersections.add(Intersection::new(1.8589, shape));
