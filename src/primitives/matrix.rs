...
mod tests {
    ...
    fn transpose_matrix() {
        ...
        let matrix_2_transposed = Matrix::<2>::new([
            [1.0, 5.5],
            [2.0, 6.5]
        ]);
        let matrix_3 = Matrix::<3>::new([
        ...
        let matrix_3_transposed = Matrix::<3>::new([
            [0.0, 9.0, 1.0],
            [9.0, 8.0, 8.0],
            [3.0, 0.0, 5.0]
        ]);
